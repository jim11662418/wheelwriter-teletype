...
volatile unsigned int xdata rx3_buf[RBUFSIZE3]; // receive buffer for UART3 in internal MOVX RAM
...
//  it is stored in S3RB8 (S3CON.2). The baud rate is determined by the T3 overflow rate.
